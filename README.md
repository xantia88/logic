...
Вверху есть труднопроизносимое слово discontiguous, оно нужно что бы было четкое постулировано описание единого языка базы знаний. Важно понять эту концепцию, если данные - это код, то их можно и читать (глазами или сторонними средствами) и исполнять, если же данные это просто данные, то на их можно читать (глазами или сторонними средствами), но нельзя исполнять.
