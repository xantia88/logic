...
2. Построение ахитектурной модели дочернего общества на базе архитектурной модели родительской компании ввиде базы знаний на языке Prolog
     ...
     - Автоматически, с помощью диалоговых систем, построенных на базе архитектурной модели родительской компании
...
7. Автоматическое формирование архитектурных решений и рекомендаций с использований логических моделей заданных родительской компанией
