...
Ниже приведен список сущностей предметной области, используемый для описания архитектуры дочернего общества. Для каждой сущности определены правила проверки ее логической структуры (**validate**) и правила анаиза этой структуры с выводом сообщений об ошибках (**explain**).
