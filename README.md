...
|2.1|Ввиде текстового описания на языке предметной области|Статическое представление знаний, используя модель предметной области, пригодное для чтения и анализа как человеком, так и машиной|В текстовом файле, на языке, заложенным в модели предметной области|
|2.2|С помощью диалоговых систем, построенных на базе логической модели|Быстрый и удобный способ работы со знаниями|Используя диалоговые системы, построенные на базе модели знаний на языке Prolog|
|2.3|С помощью интеллектуального помощника, знакомого с языком предметной области разработанной логической модели|Быстрый и удобный способ работы со знаниями|Используя GigaChat|
|3|Реализовать функциональность сравнения разных версий баз знаний|Найти что изменилось и проанализировать разницу между двумя состояниями базы знаний (двумя версиями архитектуры)|Сравнить все факты и отношения в двух базах знаний|
|4|Экспортировать данные архитектуры дочернего общества в форматы - YAML (DocHub), SQL (PostgreSQL), XML (ArchiMate)|Возможность работы с данными в сторонних инструментах|Создать текстовые файлы, содержащие данные из базы знаний|
