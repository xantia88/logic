...
|3|Реализовать диалоговые системы для взаимодействия с базой знаний|Быстрый и удобный способ работы со знаниями|Диалоги на беза логической модели на языке Prolog|
|5|Реализовать интеллектуального помощника, знакомого с языком предметной области логической модели|Быстрый и удобный способ работы со знаниями|Применить GigaChat для перевода с русского на язык предметной области и с языка предметной области на русский|
|5|Экспортировать данные архитектуры дочернего общества в форматы - YAML (DocHub), SQL (PostgreSQL), XML (ArchiMate)|Возможность работы с данными в сторонних инструментах|Создать текстовые файлы, содержащие данные из базы знаний|
|6|Сформировать архитектурные решения и рекомендации с использований логических моделей, разработанных родительской компанией или дочерней компанией|Применение лучших практик, шаблонов проектирования, проверка стандартов|Описание "что правильно" ввиде логической модели на языке Prolog, с целью применить эту модель к базе знаний и получить ответы - "что неправильно" и "как сделать правильно"|
