...
|5|Экспортировать данные из базы знаний в форматы - YAML, SQL, XML (ArchiMate)|Возможность работы с данными в сторонних инструментах|Создать текстовые файлы, содержащие данные из базы знаний|
