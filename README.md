...
Данные - следы проявления объектов и процессов в реальном мире. Эти следы можно использовать для сравнения с известными знаниями (Data Analysis) или поиска новых знаний (Data Mining, Knowledge Discovery).  
