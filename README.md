...
Основная цель данного проекта - применить стандартные инструмменты логического программирования для работы со знаниями о корпоративной архитектуре организации.
