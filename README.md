...
|2|Описать архитектуру дочернего общества ввиде базы знаний согласно разработанной модели|Цифровизация знаний, работа со знаниями на языке предметной области, повторяемые логические вывода и запросы к базе знаний|База знаний на языке Prolog|
...
|3|Реализовать функциональность сравнения двух разных версий баз знаний|Найти что изменилось и проанализировать разницу между двумя состояниями базы знаний (двумя версиями архитектуры)|Сравнить все факты и отношения в двух версиях баз знаний|
|4|Экспорт данных архитектуры дочернего общества в форматах YAML (DocHub), SQL, XML (ArchiMate)|Возможность работы с данными в сторонних инструментах|Создать текстовые файлы, содержащие данные из базы знаний|
