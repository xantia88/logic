...
Модель предметной области определяет связанные между собой абстракции. База знаний работает с данными на уровне абстракций, но данные можно экспортировать ввиде текстовых файлов в нужном формате. Такое разделение очень полезно, т.к. позволяет отделить описание и формат от логических структур предметной области и выстроить процесс моделирования без лишних усложнений и с использованием сторонних инструментов.  
