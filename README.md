...
|2.1|Реализовать диалоговые системы для взаимодействия с базой знаний|Быстрый и удобный способ работы со знаниями|Диалоги на беза логической модели на языке Prolog|
|2.2|Реализовать интеллектуального помощника, знакомого с языком предметной области логической модели|Быстрый и удобный способ работы со знаниями|Применить GigaChat для перевода с русского на язык предметной области и с языка предметной области на русский|
