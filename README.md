...
Выводы:
 ...
 - При загрузки данных в память база знаний размещается оптимальным образом, таким образом, что логическая валидации практически не зависит от объема данных
