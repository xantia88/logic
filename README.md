...
Ниже приведен список сущностей предметной области, используемый для описания архитектуры дочернего общества. Для каждой сущности определены правила проверки ее логической структуры (**validate**) и вывод сообщений о том, где структура невалидна (**explain**).
